...
$search=($_POST['search']);
$reqRech="SELECT  R.matiere,R.url from ressource R  join module M on R.idM_R=M.idM where matiere LIKE '{$search}%' or url LIKE  '{$search}%'  ";
  $rech=$connect->query($reqRech);
 
 echo' <div class="row">';
 echo' <div class="col-lg-11 col-md-8 col-sm-12" >';
 echo"<div id='AQ'>Résultat du recherche</div>";
