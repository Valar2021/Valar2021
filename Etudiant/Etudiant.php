...
<body>
  <header class="header">
    ...
    <div style=" color:white;" class="header-icons">
      ...
      <a href="./notification.php"><span class="label label-pill label-danger count" style="border-radius:10px;"></span> <i style="color: white;" class="fas fa-bell"></i></a>
  ...
  <div class="container1">
    <nav>
      <div class="side_navbar">
        ...
        <!-- <a href="./notification.php"><i class="bi bi-bell"></i> Notification des cours</a> -->
  ...
  <i class="bi bi-lock"></i> changer son mot de passe
  </button>
