...
<i class="bi bi-plus-lg"></i> Ajouter etudiant
</button>
...
<div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
 ...
 <div class="form signup">
              <span class="title">Ajouter etudiant</span>
              ...
              <form  method="POST" action="./TraiteEtudiant.php" enctype="multipart/form-data" id="form">
                  ...
                  <div class="input-field">
                      <input type="text" placeholder="Entrer son numéro de carte d'étudiant" name="nce" id="nce" required>
                  ...
                  <div class="input-field">
                      <input type="text" class="password" placeholder="Entrer sa classe" name="classe" id="classe" required>
                      <i class="uil uil-lock icon"></i>
                      <i class="uil uil-eye-slash showHidePw"></i>
                  </div>
                  <div class="input-field">
                      <input type="email" class="email" placeholder="Entrer son email" name="email" id="email"required>
                      <i class="uil uil-lock icon"></i>
                      <i class="uil uil-eye-slash showHidePw"></i>
                  </div>
                  <div class="input-field">
                      <input type="date" class="date" placeholder="Entrer sa date de naissance" name="date" id="date"required>
                      <i class="uil uil-lock icon"></i>
                      <i class="uil uil-eye-slash showHidePw"></i>
                  </div>
                  <div class="input-field">
                      <input type="number" class="tel" placeholder="Entrer son numero de téléphone" name="tel" id="tel"required>
                      <i class="uil uil-lock icon"></i>
                      <i class="uil uil-eye-slash showHidePw"></i>
                  </div>
...
<?php
  ...
  if($connect)
  $re="SELECT   id,nom,prenom, nce,password,classe,email,date,tel  FROM etudiant ;";
...
echo"<tr>";
 ...
 echo"<td>$h</td>";
 echo"<td> 
 <a href='./editEtu.php?id=$a'><i   style='font-size:130%' class='bi bi-pencil-fill'></i> </a>
       <a href='deleteEt.php?id=$a'><i  style='color :red;font-size:130%' class='bi bi-trash ' onclick='return confirmation();'></i></a><br><br>
