<?php
  ...
  $id=$_GET['id'];
  $req=" SELECT * from  enseignant where id=$id";
...
<body>
   ...
   <div class="container col-lg-5 col-md-8 col-sm-12">
    <a id="back" href="./AddEnseignant.php"> <button type="button" class="btn btn-dark"> <i class="bi bi-arrow-left-circle"></i> Retouner</button> </a> 
    
  
<div class="form signup">
             <span class="title">Modifier enseignant</span>

             <form  method="POST" action="./traiteEdit.php" enctype="multipart/form-data" id="form">
