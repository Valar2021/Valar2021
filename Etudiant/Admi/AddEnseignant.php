...
<div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
 ...
 <div class="form signup">
              ...
              <form  method="POST" action="./TraiteEnseignant.php" enctype="multipart/form-data" id="form">
...
<?php
  ...
  if($connect)
  $re="SELECT  id,nom,prenom,username,Password,grade FROM enseignant ;";
...
echo"<tr>";
 ...
 echo"<td>$e</td>";
 echo"<td> 
 <a href='edit.php?id=$a'><i   style='font-size:130%' class='bi bi-pencil-fill'></i></a>
 <a href='delete.php?id=$a'><i  style='color :red;font-size:130%' class='bi bi-trash ' onclick='return confirmation();'></i></a><br><br>
